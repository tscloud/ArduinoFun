...
static int pinA = 13; // Our first hardware interrupt pin is digital pin 2
...
const byte buttonPin = 12; // this is the Arduino pin we are connecting the push button to
